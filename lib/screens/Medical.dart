...
class _MedicalState extends State<Medical> {
  ...
  accept_request(Index1){
    if(emergency_type_1[Index1][4]=='not accepted'){
      print(emergency_type_1[Index1][5]);
      firestoreInstance.collection("Group_Messages").doc(emergency_type_1[Index1][5]).update(
          {
            ...
            Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text(emergency_type_1[Index1][0],style:TextStyle(fontSize: 25,fontWeight: FontWeight.bold)),
                    SizedBox(height: 10,),
                    Text(emergency_type_1[Index1][3],style:TextStyle(fontSize: 20)),
                    SizedBox(height: 15,),
                    Row(
                      children: [
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            SizedBox(height: 15,),
            Center(child: Text("Medical Emergency",style:TextStyle(fontSize: 25,fontWeight: FontWeight.bold))),
            SizedBox(height: 15,),
            if(verified==true)
              Expanded(
              child: ListView.builder(
                  itemCount: emergency_1_number,
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(emergency_type_1[Index][0],style:TextStyle(fontSize: 18,color:Colors.white)),
                                    ],
                                  ),
                                ],
                              ),
            ...
            if(verified==false)
              Expanded(child: Center(child: Text('No Medical Emergencies '))),
            Row(
